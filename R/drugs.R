...
#' All predictors were originally categorical and were quantified by Fehrman et al. (2017). The meaning of the values can be found on https://archive.ics.uci.edu/ml/datasets/Drug+consumption+%28quantified%29. 
